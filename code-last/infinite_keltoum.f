...
c        if (nrm0f .gt. 1.D-15) then
c 	      write(*, *) 'L''erreur ponderee L2 relative (MEF)  :',
c     &                erreurL2f/nrm0f
c        else
c          write(*, *) 'L''erreur ponderee L2 relative (MEF)  :',
c     &                'undefined (nrm0f too small)'
c        endif
c        if (nrm1f .gt. 1.D-15) then
c 	      write(*, *) 'L''erreur ponderee H1 relative (MEF)  :',
c    &                errGrdf/nrm1f
c        else
c          write(*, *) 'L''erreur ponderee H1 relative (MEF)  :',
c     &                'undefined (nrm1f too small)'
c        endif
	    close(24)
       end
